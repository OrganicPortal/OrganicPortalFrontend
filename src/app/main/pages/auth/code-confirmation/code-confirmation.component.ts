...
@Component({
	selector: "app-code-confirmation", templateUrl: "./code-confirmation.component.html", styleUrls: [
		"./code-confirmation.component.scss", "../shared/shared.styles.scss"
	], changeDetection: ChangeDetectionStrategy.OnPush, standalone: false, animations: [
		frameSideIn4
	]
})
